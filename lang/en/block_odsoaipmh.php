...
/**
 * Strings for component 'block_odsoaipmh', language 'en'
 *
...
$string['desc_allowed_ip'] =
    '<p>The list of all allowed networks for harversters. You can use any network format to specify allowed network.</p>
<p>Eg.</p>
