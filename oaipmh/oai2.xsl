...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:template name="quicklinks">
		<ul class="quicklinks">
			...
			<li>
				<a href="?verb=ListRecords&amp;metadataPrefix=oai_lom">ListRecords</a>
				| </li>
			<li>
			...
			<li>
				<a href="?verb=ListIdentifiers&amp;metadataPrefix=oai_lom"
					>ListIdentifiers</a>
			</li>
		</ul>
	</xsl:template>
...
-->
		...
		<table class="values">
			<tr>
				...
				<td class="value">
					...
					<xsl:text> </xsl:text>
					<a class="link"
						href="?verb=GetRecord&amp;metadataPrefix=oai_lom&amp;identifier={oai:identifier}">
						<xsl:value-of select="$metadataPrefix"/>
					</a>
					<xsl:text> </xsl:text>
					<a class="link"
						href="?verb=ListMetadataFormats"
						>formats</a>
				</td>
			</tr>
			<tr>
            ...
            <tr>
                ...
                <td class="value">
                    ...
                    <xsl:text> </xsl:text>
                    <a class="link"
                        href="?verb=ListIdentifiers&amp;metadataPrefix=oai_lom&amp;set={oai:setSpec}"
                        >Identifiers</a>
                    <xsl:text> </xsl:text>
                    <a class="link"
                        href="?verb=ListRecords&amp;metadataPrefix=oai_lom&amp;set={oai:setSpec}"
                        >Records</a>
                </td>
            </tr>
		</table>
	...
	<xsl:template match="oai:setSpec">
		<tr>
			...
			<td class="value">
				...
				<xsl:text> </xsl:text>
				<a class="link"
					href="?verb=ListIdentifiers&amp;metadataPrefix=oai_lom&amp;set={.}"
					>Identifiers</a>
				<xsl:text> </xsl:text>
				<a class="link"
					href="?verb=ListRecords&amp;metadataPrefix=oai_lom&amp;set={.}"
					>Records</a>
			</td>
		</tr>
	</xsl:template>
	...
	<xsl:template match="oai:resumptionToken" priority="10">
